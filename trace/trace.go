...
*/
package trace // import "github.com/token-test-tomas/net/trace"
...
import (
	...
	"github.com/token-test-tomas/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/token-test-tomas/net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of github.com/token-test-tomas/net/trace.")
	}
...
var contextKey = contextKeyT("github.com/token-test-tomas/net/trace.Trace")
